...
[![Tests](https://img.shields.io/github/workflow/status/comparison-sorting/quick-sort/ci:cover?event=push&label=tests)](https://github.com/comparison-sorting/quick-sort/actions/workflows/ci:cover.yml?query=branch:main)
